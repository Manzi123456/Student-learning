...
# SECURITY: Never hardcode API keys or read from files in production
...
# SECURITY: SMTP settings are read from environment variables only
# Never read from files in production - use environment variables in your hosting platform
...
with app.app_context():
    ...
    # SECURITY: Admin credentials are read from environment variables only
    # Never read from files in production - use environment variables in your hosting platform
